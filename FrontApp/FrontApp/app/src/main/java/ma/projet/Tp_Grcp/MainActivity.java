...
public class MainActivity extends AppCompatActivity {
    ...
    private MonCompteAdapter monCompteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        monCompteAdapter = new MonCompteAdapter(compteList); // Utilisation du nouveau nom
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(monCompteAdapter);


        new Thread(() -> serverCommunication()).start();


        fabAddCompte.setOnClickListener(v -> ajouterCompte());
    }
    ...
    private void serverCommunication() {
        ...
        try {
            ...
            runOnUiThread(() -> {
                ...
                monCompteAdapter.notifyDataSetChanged();
            });
        } catch (Exception e) {
    ...
    private void ajouterCompte() {
        View dialogView = getLayoutInflater().inflate(R.layout.dialog_ajouter_compte, null);
